    ...
    <div className="flex flex-col  gap-3 text-white m-3">
      <form onSubmit={handleFormSubmit}>
        ...
        <div className="m-4">
          ...
          <button
            type="submit"
            class="m-3 text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-10 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"
          >
            Upload
          </button>
        </div>
